...
getwd()
# Антоненко А. Н. 124 ПАЭ
# Задание 1.
# Вариант 1 
# Для региона 22 рассчитайте урожайность пшеницы в 2014 году,
# взяв для рассчета средние суммы активных температур за текущий год,
# с 20 ближайших метеостанций но рассчитав колонку di самостоятельно,
...
barnaul = data.frame(id = "BARNAUL", latitude = 53.36056,  longitude = 83.76361)
# Выполним поиск 20 ближайших метеостанций с данными по среднемесячной температуре за 2014-2015 год
#   и сохраним в вектор barnaul_around.
barnaul_around = meteo_nearby_stations(lat_lon_df = barnaul, station_data = station_data,
                                        limit = 20, var = "TAVG",
...
for (i in 1:20)
{
  # Определим станцию из 20 ближайших:
  barnaul_id = barnaul_around[["BARNAUL"]][["id"]][i]
  # Загрузим данные для станции:
  data = meteo_tidy_ghcnd(stationid = barnaul_id,
                          var="TAVG",
                          date_min="2014-01-01",
                          date_max="2014-12-31")
...
#Согласно расчету, урожайность пшеницы в Алтайском крае в 2014 году составила:
Yield = sum(clean_data$fert);
cat("Согласно расчету, урожайность пшеницы в Алтайском крае в 2014 году составила:", Yield, "ц/га")
